...
takeaways/verdict → artifact filenames*, plus a row in the file table (§19 there) and the exact
reproduce command (§20 there). A run that isn't written up there effectively doesn't exist.
