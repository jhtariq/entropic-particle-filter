"""Audio-capacity audit against a LIVE endpoint (MMAR edition of the run18/19 tool).
...
Do NOT trust a first-N smoke instead of this — metadata order biases short audio
