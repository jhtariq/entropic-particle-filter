...
#SBATCH --job-name=mmau_sc_3b
#SBATCH --output=/u/awaheed/slurm_logs/mmau_sc-%x-%j.out
#SBATCH --requeue
#SBATCH --open-mode=append
# Omni-3B SC + greedy on MMAU test-mini (the cells missing from the Aug-3 MMAU SC run).
...
export OUT_ROOT=/u/awaheed/mmau_sc_out_3b
export MMAU_MODELS="qwen_omni_3b"
